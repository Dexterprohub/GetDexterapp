...
export default function FeatureThree(){
    return (
        <div className="bg-primary bg-vector w-full py-[96px] px-[40px]">
            <div className="flex flex-col sm:flex-row justify-around items-center gap-[48px]">
                <div className="flex flex-col justify-center items-start w-[80vw] gap-8">
                    ...
                    <h2 className="font-manrope font-bold text-[35px] leading-[50px] text-white ">Our support team is always ready to help</h2>
