...
export default function FeatureTwo(props){
  return (
    <div className="flex flex-col items-center justify-between mx-auto md:py-[96px] md:px-[135px] py-[80px] px-[40px] gap-2 bg-white">
      <div className="flex  sm:flex-row items-center justify-between gap-[72px] flex-col">
        <img src={props.phone} alt="phone" className="w-[180px]"/>
        <div className="flex flex-col gap-[28px] w-[80vw]"> 
          ...
          <div className="flex flex-row items-center justify-start gap-[20px]">
            ...
            <div>
              ...
              <p className="text-shadeGrey text-[13px] leading-[20px] font-semibold w-[300px] mt-2">{props.text}</p>
            </div>
