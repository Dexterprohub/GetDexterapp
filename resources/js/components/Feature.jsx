...
export default function Feature(){
  return (
    <div className="bg-darkGrey flex flex-col justify-center items-center py-[96px] px-[40px] gap-6">
      
        <h2 className="font-bold xs:text-[40px] text-[20px] font-normal text-center text-black font-manrope">Currently available in:</h2>
      
      <div className="flex flex-row justify-start items-center gap-4">
        <img src={flagI} alt="flag" /> <h5 className="font-semibold xs:text-[20px] text-[15px]">Lagos, Nigeria </h5>
      </div>
    
        <p className="xs:text-[18px] text-[14px] text-center leading-[25px] text-darkBrown">
